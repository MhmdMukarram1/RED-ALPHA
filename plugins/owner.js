...
Rashi.addCommand({pattern: 'owner', fromMe: false, desc: 'it send owner details'}, (async (message, match) => {
    ...
    await message.sendMessage(Buffer(rashi.data), MessageType.image, {mimetype: Mimetype.png, thumbnail: fs.readFileSync('./image/said.png'), contextInfo: {mentionedJid: message.mention}, caption: `*` + config.BOTPLK + `*` + `\n\n    CREATED BY ` + zara.RED_ALPHA_OWNER + `\n\n` + `*•━━━━━━━━MHMD MUKARRAM•*`
}) 
