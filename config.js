...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'RedAlpha public bot' : process.env.ALL_CAPTION,
    ...
    BOTPLK: process.env.BOT_NAME === undefined ? 'Red Alpha' : process.env.BOT_NAME,
    ...
    RASHI: process.env.LOGO_LINK === undefined ? 'https://i.ibb.co/XpKLnJb/mhm.jpg' : process.env.LOGO_LINK,
    ...
    TAGPLK: process.env.TAG_HEADER === undefined ? 'redalpha' : process.env.TAG_HEADER,
